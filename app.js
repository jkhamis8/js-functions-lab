...
const basicCalculator = (one, two, type) => {
  if (type == 'add') {
    return one + two
...
const createUsername = (fisrtname, lastname) => {
  return (
    fisrtname.substr(0, 3) +
    lastname.substr(0, 3) +
    (fisrtname.length + lastname.length)
  )
}
